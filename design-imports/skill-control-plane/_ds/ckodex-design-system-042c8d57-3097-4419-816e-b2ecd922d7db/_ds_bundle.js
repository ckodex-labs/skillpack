/* @ds-bundle: {"format":4,"namespace":"CkodexDesignSystem_042c8d","components":[{"name":"AuditTrail","sourcePath":"components/AuditTrail.jsx"},{"name":"AuthorityFooter","sourcePath":"components/AuthorityFooter.jsx"},{"name":"Button","sourcePath":"components/Button.jsx"},{"name":"CiqrPath","sourcePath":"components/CkCiqr.jsx"},{"name":"CkCiqr","sourcePath":"components/CkCiqr.jsx"},{"name":"CkIcon","sourcePath":"components/CkIcon.jsx"},{"name":"CK_ICON_NAMES","sourcePath":"components/CkIcon.jsx"},{"name":"ComplianceMatrix","sourcePath":"components/ComplianceMatrix.jsx"},{"name":"MATRIX_GLYPHS","sourcePath":"components/ComplianceMatrix.jsx"},{"name":"Redaction","sourcePath":"components/DisclosureRecord.jsx"},{"name":"DisclosureRecord","sourcePath":"components/DisclosureRecord.jsx"},{"name":"DISCLOSURE_GLYPH","sourcePath":"components/DisclosureRecord.jsx"},{"name":"EntityCard","sourcePath":"components/EntityCard.jsx"},{"name":"ENTITY_KINDS","sourcePath":"components/EntityCard.jsx"},{"name":"EvidenceHash","sourcePath":"components/EvidenceHash.jsx"},{"name":"EvidenceMargin","sourcePath":"components/EvidenceMargin.jsx"},{"name":"PageShell","sourcePath":"components/PageShell.jsx"},{"name":"ProvenanceStamp","sourcePath":"components/ProvenanceStamp.jsx"},{"name":"QuietCard","sourcePath":"components/QuietCard.jsx"},{"name":"Sparkline","sourcePath":"components/Sparkline.jsx"},{"name":"StateChip","sourcePath":"components/StateChip.jsx"}],"sourceHashes":{"components/AuditTrail.jsx":"dc1b90ae3cf7","components/AuthorityFooter.jsx":"d5a0a1b9d432","components/Button.jsx":"34c9647fda88","components/CkCiqr.jsx":"5b578f5a413d","components/CkIcon.jsx":"5a14af779ab2","components/ComplianceMatrix.jsx":"cdf3c2c6728d","components/DisclosureRecord.jsx":"47853ea827dd","components/EntityCard.jsx":"29aa508d41b9","components/EvidenceHash.jsx":"a7b342914354","components/EvidenceMargin.jsx":"f1e4e2e12a7f","components/PageShell.jsx":"906a115b0e58","components/ProvenanceStamp.jsx":"c7d3232aba6f","components/QuietCard.jsx":"f9b81787944b","components/Sparkline.jsx":"823fda2c10e1","components/StateChip.jsx":"bfd4d3a1eb2e","dotbg.js":"55b8d393f1ce","redesign-v2/console-v2-primitives.jsx":"d571e22e543b","redesign-v2/console-v2-shell.jsx":"06b674426447","redesign-v2/console-v2-views.jsx":"c1a54216f65d","redesign-v2/hero-scenes.js":"8f83f8ad7c2c","redesign-v2/tweaks-panel.jsx":"6591467622ed","ui_kits/governance-console/App.jsx":"28dbdb437dd1","ui_kits/governance-console/ArtifactsView.jsx":"6b9737a2f69c","ui_kits/governance-console/AttestationReview.jsx":"e096c3a804e6","ui_kits/governance-console/Header.jsx":"cdcbc76a25c4","ui_kits/governance-console/KernelDetail.jsx":"8a38d9a7681b","ui_kits/governance-console/Overview.jsx":"686ed31768a1","ui_kits/governance-console/PolicyView.jsx":"23912accb24b","ui_kits/governance-console/RekorView.jsx":"65929cb76963","ui_kits/governance-console/Sidebar.jsx":"748b6f19dc9c","ui_kits/governance-console/primitives.jsx":"7fa0b429e55c"},"inlinedExternals":[],"unexposedExports":[]} */
...
try { (() => {
/* CKODEX-DS-3 · AuditTrail — who · what evidence · when.
 * A vertical ledger of governance decisions: each entry names the
 * actor (who), the action and its evidence (what), and the time
 * (when). It makes the decision provenance legible — the audit
 * complement to the Evidence Margin's receipts. Color obeys the
 * budget: the rail node and the evidence digest earn violet only
 * when the evidence is a proof object (`kind: 'proof'`) and red only
 * on an active emergency protocol (`kind: 'alarm'`). Requires
 * styles.css. */
function AuditTrail({
  entries = [],
  className = '',
  ...
  return h('div', {
    className: ('ck-trail ' + className).trim(),
    ...rest
  }, entries.map((e, i) => {
    const mod = e.kind ? ' ck-trail__entry--' + e.kind : '';
    const glyph = e.kind === 'proof' ? '◆' : e.kind === 'alarm' ? '⊘' : '≡';
    return h('div', {
      className: 'ck-trail__entry' + mod,
      key: i
    }, h('div', {
      className: 'ck-trail__rail'
    }, h('div', {
      className: 'ck-trail__line'
    }), h('div', {
      className: 'ck-trail__node'
    })), h('div', {
      style: {
        minWidth: 0
      }
    }, h('div', {
      className: 'ck-trail__action'
    }, e.action), h('div', {
      className: 'ck-trail__meta'
    }, e.actor ? h('span', {
      className: 'ck-trail__actor'
    }, e.actor) : null, e.actor && e.time ? ' · ' : '', e.time || ''), e.evidence ? h('div', {
      className: 'ck-trail__evidence'
    }, h('span', {
      className: 'ck-hash',
      title: e.evidence
    }, h('span', {
      'aria-hidden': 'true'
    }, glyph), e.evidence)) : null));
  }));
}
Object.assign(__ds_scope, { AuditTrail });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/AuditTrail.jsx", error: String((e && e.message) || e) }); }

// components/AuthorityFooter.jsx
try { (() => {
...
/* CKODEX-DS-3 · AuthorityFooter — the handling band.
   ...
   Drive it by environment to derive the level, or set reveal="on-demand"
   to dock it to the viewport bottom behind a peek handle (and an
   optional keyboard shortcut).

   PROVENANCE BAND (v4): pass `classification` / `tier` / `proof` and
   the band becomes an attestation strip over a named artifact —
   classification rail (scoped hue, hatched when restricted), evidence
   tier (E-scale mapped to claimed·scanned·validated·proved), live
   sha-256 content digest of the artifact (`artifact` selector), an
   expandable proof panel (URN · signature · transparency anchor ·
   CIQR), and a governed Copy-for-AI hand-off gated by classification.
   Two axes, never conflated: `level` asserts the HANDLING of the
   surface; `classification` marks the DATA of the artifact.
   Requires styles.css. */
...
const AUTHORITY_LEVELS = {
  open: {
    glyph: '○',
    label: 'Open',
    handling: 'unrestricted handling'
  },
  internal: {
    glyph: '◇',
    label: 'Internal',
    handling: 'controlled handling'
  },
  restricted: {
    glyph: '◈',
    label: 'Restricted',
    handling: 'sensitive · need-to-know'
  },
  sealed: {
    glyph: '◆',
    label: 'Sealed',
    handling: 'proof-bound environment'
  },
  contained: {
    glyph: '⊘',
    label: 'Contained',
    handling: 'active emergency protocol'
  }
};
const AUTHORITY_INVARIANT = 'mode changes deployment, not governance semantics';

/* classification — data marking of the attested artifact (closed set) */
const AUTHORITY_CLS = {
  public: {
    label: 'Public'
  },
...
/* evidence tier — E-scale mapped to the four words; glyphs from the
   safe-set, never dots. E5 is violet ONLY with a proof object. */
const AUTHORITY_TIERS = {
  E0: {
    word: 'claimed',
    glyph: '○',
    k: 'none',
    note: ['Claimed.', 'No discharging artifact resolves yet. Treat as unproven.']
  },
  E1: {
    word: 'scanned',
    glyph: '◌',
    k: 'none',
    note: ['Scanned.', 'Automated checks ran; findings are not independently validated.']
  },
  E3: {
    word: 'validated',
    glyph: '●',
    k: 'mid',
    note: ['Empirically validated.', 'Conformance vectors pass; not kernel-checked.']
  },
  E5: {
    word: 'proved',
    glyph: '◆',
    k: 'proof',
    note: ['Kernel-proved.', 'Discharging proof object present and verified.']
  }
};

/* hand-off gates — classification governs egress; deny-by-default */
const AUTHORITY_GATES = {
  public: {
    copy: true,
    banner: null,
    gate: 'copy: allowed · send: policy-gated',
    note: ['Public.', 'Copies as a governed bundle — provenance travels; payload marked data-not-instructions.']
  },
  internal: {
    copy: true,
    banner: 'INTERNAL — internal use only',
    gate: 'copy: allowed · send: policy-gated',
    note: ['Internal.', 'Copy allowed; the bundle carries the classification so the receiver inherits handling.']
  },
  confidential: {
    copy: true,
    banner: 'CONFIDENTIAL — handle per policy',
    gate: 'copy: allowed (banner) · send: blocked',
    note: ['Confidential.', 'Copy carries a handling banner in the payload. External send is blocked without policy ack.']
  },
  restricted: {
    copy: false,
    banner: null,
    gate: 'copy: blocked · send: blocked',
    note: ['Restricted.', 'Copy for AI is disabled — restricted artifacts do not cross the boundary without policy ack (egress deny-by-default).']
  }
};
function fmtAuthorityDigest(d) {
  if (!d) return '';
  const m = String(d).match(/^([a-z0-9-]+:)(.+)$/i);
  const prefix = m ? m[1] : '';
  const hex = m ? m[2] : String(d);
  return prefix + (hex.length > 12 ? hex.slice(0, 4) + '…' + hex.slice(-4) : hex);
}
function authorityHex(d) {
  if (!d) return '';
  const m = String(d).match(/^[a-z0-9-]+:(.+)$/i);
  return m ? m[1] : String(d);
}

/* deterministic canonical body — headings, paragraphs, fenced code */
function ckCanonicalBody(root) {
  ...
  root.querySelectorAll('h1,h2,h3,h4,h5,h6,p,pre').forEach(el => {
    ...
    if (tag[0] === 'h') {
      out.push('#'.repeat(+tag[1]) + ' ' + el.textContent.trim().replace(/\s+/g, ' '));
    } else if (tag === 'p') {
      ...
      let lang = '';
      if (code) {
        const lc = [...code.classList].find(c => c.indexOf('language-') === 0);
        if (lc) lang = lc.slice(9);
      }
      const txt = (code ? code.textContent : el.textContent).replace(/^\n+|\n+$/g, '');
      out.push('```' + lang + '\n' + txt + '\n```');
    }
  });
  return out.join('\n\n').trim();
}
function ckSha256(str) {
  if (window.crypto && crypto.subtle) {
    return crypto.subtle.digest('SHA-256', new TextEncoder().encode(str)).then(buf => [...new Uint8Array(buf)].map(b => b.toString(16).padStart(2, '0')).join(''));
  }
  return Promise.resolve(null); // insecure context — caller falls back to static digest
}
function AuthorityCopyBtn({
  value,
  label = 'Copy'
}) {
  ...
  const onCopy = e => {
    ...
    if (navigator.clipboard) navigator.clipboard.writeText(value).then(fin, fin);else fin();
  };
  return /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ck-authority__copy",
...
function AuthorityFact({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ck-authority__fact"
  }, /*#__PURE__*/React.createElement("dt", null, label), /*#__PURE__*/React.createElement("dd", null, children));
}
function AuthorityFooter({
  ...
  const [liveDigest, setLiveDigest] = React.useState(null); // {hex, live}
  const panelId = React.useId();

  /* dev guards — the palette is the policy */
  if (level === 'sealed' && !digest) {
    console.warn('[AuthorityFooter] level="sealed" earns violet only with a proof object — pass `digest`.');
  }
  if (level === 'contained' && !ep) {
    console.warn('[AuthorityFooter] level="contained" earns red only with an active emergency protocol — pass `ep`.');
  }
  if (classification && !AUTHORITY_CLS[classification]) {
    console.warn('[AuthorityFooter] classification is a closed set: public · internal · confidential · restricted.');
  }
  if (tier && !AUTHORITY_TIERS[tier]) {
    console.warn('[AuthorityFooter] tier is a closed set: E0 · E1 · E3 · E5.');
  }
  if (tier === 'E5' && !(proof && (proof.digest || proof.signature)) && !artifact) {
    console.warn('[AuthorityFooter] tier="E5" is violet only with a discharging proof object — pass `proof` (or `artifact`).');
  }
  React.useEffect(() => {
    ...
    const onKey = e => {
      ...
      if (e.key.toLowerCase() === String(shortcut).toLowerCase()) {
        e.preventDefault();
        setRevealed(v => {
          const n = !v;
  ...
  /* live content digest of the attested artifact */
  React.useEffect(() => {
    if (!provenance || !artifact) return undefined;
    let gone = false;
    const el = typeof artifact === 'string' ? document.querySelector(artifact) : artifact;
    if (!el) return undefined;
    ckSha256(ckCanonicalBody(el)).then(hex => {
      if (!gone && hex) setLiveDigest({
        hex,
        live: true
      });
    });
  ...
  if (provenance) {
    ...
    const expandToggle = () => setExpanded(v => {
      const n = !v;
      if (onExpand) onExpand(n);
      return n;
    });
    ...
    return /*#__PURE__*/React.createElement("footer", _extends({
      className: ('ck-authority ck-authority--' + level + ' ck-authority--prov ' + className).trim(),
      "data-cls": classification || undefined,
      role: "contentinfo",
      "aria-label": 'Authority footer — ' + (clsCfg ? clsCfg.label + ' artifact, ' : '') + cfg.label + ' handling'
    }, rest), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ck-authority__strip",
      "aria-expanded": expanded,
      "aria-controls": panelId,
      onClick: expandToggle
    }, clsCfg ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__rail",
      "aria-hidden": "true"
    }), /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__cls"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__swatch",
      "aria-hidden": "true"
    }), clsCfg.label)) : null, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__id"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__name"
    }, name || authority + (policySet ? ' / ' + policySet : '')), digestHex ? /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__fp"
    }, "#", digestHex.slice(0, 12)) : null), /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__stripend"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__level"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__glyph",
      "aria-hidden": "true"
    }, cfg.glyph), cfg.label), tierCfg ? /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__tier",
      "data-tier": tierCfg.k
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__tglyph",
      "aria-hidden": "true"
    }, tierCfg.glyph), tier, " \xB7 ", tierCfg.word) : null, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__chev",
      "aria-hidden": "true"
    }, expanded ? '△' : '▽'))), /*#__PURE__*/React.createElement("section", {
      className: "ck-authority__panel",
      id: panelId,
      hidden: !expanded,
      "aria-label": "Evidence material"
    }, /*#__PURE__*/React.createElement("div", {
      className: "ck-authority__grid"
    }, /*#__PURE__*/React.createElement("dl", {
      className: "ck-authority__facts"
    }, /*#__PURE__*/React.createElement("p", {
      className: "ck-authority__eyebrow"
    }, "Proof object"), p.urn ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Identity (URN)"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, p.urn), /*#__PURE__*/React.createElement(AuthorityCopyBtn, {
      value: p.urn
    })) : null, digestHex ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: 'Content digest · sha-256 · ' + (digestLive ? 'live' : 'static')
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, fmtAuthorityDigest('sha256:' + digestHex)), /*#__PURE__*/React.createElement(AuthorityCopyBtn, {
      value: digestHex,
      label: "Copy full"
    })) : null, p.signature ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Signature"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, p.signature.length > 28 ? p.signature.slice(0, 28) + '…' : p.signature), /*#__PURE__*/React.createElement(AuthorityCopyBtn, {
      value: p.signature,
      label: "Copy full"
    })) : null, p.evbRef ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Evidence bundle \xB7 transparency anchor"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, p.evbRef), p.rekorUrl ? /*#__PURE__*/React.createElement(AuthorityCopyBtn, {
      value: p.rekorUrl,
      label: "Copy anchor URL"
    }) : null) : null, clsCfg ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Classification \xB7 sealed at issue"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__chip"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__swatch",
      "aria-hidden": "true"
    }), clsCfg.label)) : null, tierCfg ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Assurance"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val"
    }, /*#__PURE__*/React.createElement("b", null, tierCfg.note[0]), " ", tierCfg.note[1])) : null, /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Authority"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, "\u22A2 ", authority, policySet ? ' / ' + policySet : '', " \xB7 ", environment, " \xB7 mode: ", mode)), p.sealedAt ? /*#__PURE__*/React.createElement(AuthorityFact, {
      label: "Sealed"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__val ck-authority__val--mono"
    }, p.sealedAt)) : null), p.ciqr ? /*#__PURE__*/React.createElement("div", {
      className: "ck-authority__qr"
    }, /*#__PURE__*/React.createElement("svg", {
      viewBox: '0 0 ' + p.ciqr.modules + ' ' + p.ciqr.modules,
      role: "img",
      shapeRendering: "crispEdges",
      "aria-label": "Scan to resolve canonical evidence",
      xmlns: "http://www.w3.org/2000/svg"
    }, /*#__PURE__*/React.createElement("path", {
      d: p.ciqr.path,
      fill: "currentColor"
    })), /*#__PURE__*/React.createElement("small", null, "CIQR \xB7 scan to resolve canonical evidence")) : null, copyForAI ? /*#__PURE__*/React.createElement("div", {
      className: "ck-authority__handoff"
    }, /*#__PURE__*/React.createElement("div", {
      className: "ck-authority__handoff-head"
    }, /*#__PURE__*/React.createElement("p", {
      className: "ck-authority__eyebrow",
      style: {
        border: 0,
    ...
    }, "Hand-off"), /*#__PURE__*/React.createElement("span", {
      className: "ck-authority__gate"
    }, gate.gate)), /*#__PURE__*/React.createElement("div", {
      className: "ck-authority__handoff-row"
    }, /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ck-btn ck-btn--quiet",
      disabled: !gate.copy,
      "aria-disabled": !gate.copy,
      onClick: copyAI
    }, "Copy for AI", !gate.copy ? ' · restricted' : classification === 'confidential' ? ' · confidential' : ''), /*#__PURE__*/React.createElement("button", {
      type: "button",
      className: "ck-btn ck-btn--ghost",
      disabled: true,
      "aria-disabled": "true",
      title: "External model egress is deny-by-default; requires tenant policy ack"
    }, "Send to model \xB7 policy-gated")), /*#__PURE__*/React.createElement("p", {
      className: "ck-authority__note"
    }, /*#__PURE__*/React.createElement("b", null, gate.note[0]), " ", gate.note[1])) : null)));
  }

  /* ---------- classic handling band ---------- */
  const authorityText = '⊢ ' + authority + (policySet ? ' / ' + policySet : '');
  let endK, endV;
  if (level === 'sealed' && digest) {
    endK = 'policy seal';
    endV = fmtAuthorityDigest(digest);
  ...
  const band = /*#__PURE__*/React.createElement("footer", _extends({
    className: ('ck-authority ck-authority--' + level + ' ' + className).trim(),
    role: "contentinfo",
    "aria-label": 'Authority footer — ' + cfg.label + ' handling'
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "ck-authority__zone ck-authority__zone--start"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__k"
  }, "authority"), /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__v",
    title: authority + (policySet ? ' / ' + policySet : '')
  }, authorityText)), /*#__PURE__*/React.createElement("div", {
    className: "ck-authority__center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__level"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__glyph",
    "aria-hidden": "true"
  }, cfg.glyph), cfg.label), /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__handling"
  }, cfg.handling)), /*#__PURE__*/React.createElement("div", {
    className: "ck-authority__zone ck-authority__zone--end"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__k"
  }, endK), /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__v"
  }, endV), invariant ? /*#__PURE__*/React.createElement("span", {
    className: "ck-authority__invariant"
  }, AUTHORITY_INVARIANT) : null));
  if (!onDemand) return band;
  return /*#__PURE__*/React.createElement("div", {
    className: "ck-authority-dock",
    "data-revealed": revealed ? 'true' : 'false'
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: 'ck-authority__handle ck-authority__handle--' + level,
    "aria-expanded": revealed,
    "aria-label": (revealed ? 'Hide' : 'Show') + ' authority footer — ' + cfg.label + ' handling',
    onClick: toggle
  }, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true"
  }, cfg.glyph), cfg.label, shortcut ? ' · ' + String(shortcut).toUpperCase() : ''), band);
}
Object.assign(__ds_scope, { AuthorityFooter });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/AuthorityFooter.jsx", error: String((e && e.message) || e) }); }
...
// components/CkCiqr.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/* CKODEX-DS-3 · CkCiqr — the canonical identity code.
 *
 * A REAL QR encoder (ISO/IEC 18004 byte mode, EC level L, versions
 * 1–5 ≤ 106 bytes, mask 0), rendered in the drafting discipline:
 * ink modules on bg-0, a true quiet zone, a hairline-strong frame.
 * No styled modules, no logos, no gradients — a code is evidence,
 * not decoration. The frame earns violet ONLY when `attested`
 * (the payload resolves to a proof object).
 *
 * `CiqrPath(payload)` → { path, modules } is exported for surfaces
 * that take a precomputed code (AuthorityFooter's `proof.ciqr`).
 * Requires styles.css. */

/* ---------- GF(256), poly 0x11d ---------- */
const CIQR_EXP = new Uint8Array(512);
const CIQR_LOG = new Uint8Array(256);
(function () {
  let x = 1;
  for (let i = 0; i < 255; i++) {
    CIQR_EXP[i] = x;
  ...
  for (let i = 255; i < 512; i++) CIQR_EXP[i] = CIQR_EXP[i - 255];
})();
function ciqrPolyMul(a, b) {
  const r = new Array(a.length + b.length - 1).fill(0);
  for (let i = 0; i < a.length; i++) {
    for (let j = 0; j < b.length; j++) {
      if (a[i] && b[j]) r[i + j] ^= CIQR_EXP[(CIQR_LOG[a[i]] + CIQR_LOG[b[j]]) % 255];
    }
  }
  return r;
}
function ciqrRS(data, ecLen) {
  let gen = [1];
  for (let i = 0; i < ecLen; i++) gen = ciqrPolyMul(gen, [1, CIQR_EXP[i]]);
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    for (let j = 0; j < gen.length; j++) {
      res[i + j] ^= CIQR_EXP[(lf + CIQR_LOG[gen[j]]) % 255];
    }
  }
  return res.slice(data.length);
}

/* format info: (EC-L=01 | mask) → BCH(15,5) → XOR mask */
function ciqrFormatBits(maskId) {
  ...
  let d = data << 10;
  while (blen(d) >= blen(G)) d ^= G << blen(d) - blen(G);
  return (data << 10 | d) ^ 0b101010000010010;
}

/* EC level L, single RS block, versions 1–5 */
const CIQR_VERSIONS = [{
  v: 1,
  data: 19,
  ec: 7,
...
function ciqrMatrix(payload) {
  ...
  const V = CIQR_VERSIONS.find(t => bytes.length <= t.data - 2);
  if (!V) return null;
  const size = 17 + 4 * V.v;

  /* bitstream: mode 0100 · 8-bit count · bytes · terminator · pads */
  const bits = [];
  const push = (val, n) => {
  ...
  push(0, Math.min(4, V.data * 8 - bits.length));
  ...
  let pi = 0;
  while (data.length < V.data) data.push(PADS[pi++ % 2]);
  const cw = data.concat(ciqrRS(data, V.ec));

  /* matrix: null = data cell */
  const m = Array.from({
    length: size
  ...
  /* format info (mask 0) + dark module */
  const fmt = ciqrFormatBits(0);
  for (let i = 0; i < 15; i++) {
    const mod = (fmt >> i & 1) === 1;
    if (i < 6) m[i][8] = mod;else if (i < 8) m[i + 1][8] = mod;else m[size - 15 + i][8] = mod;
    if (i < 8) m[8][size - i - 1] = mod;else if (i < 9) m[8][15 - i] = mod;else m[8][14 - i] = mod;
  }
  m[size - 8][8] = true;

  /* zigzag data placement, mask 0 = (r+c)%2===0 */
  let inc = -1,
    row = size - 1,
    bitIndex = 7,
    byteIndex = 0;
...
/* Precomputed-path form for surfaces that take proof.ciqr = {path, modules}. */
function CiqrPath(payload) {
  const q = ciqrMatrix(payload);
  if (!q) {
    console.warn('[CkCiqr] payload exceeds 106 bytes (version 5 · EC-L) — no code generated.');
    return null;
  }
  let path = '';
  for (let r = 0; r < q.size; r++) {
    for (let c = 0; c < q.size; c++) {
      if (q.m[r][c]) path += 'M' + c + ' ' + r + 'h1v1h-1z';
    }
  }
  return {
    path,
...
function CkCiqr({
  ...
  attested = false,
  label = 'CIQR',
  caption = 'scan to resolve canonical evidence',
  className = '',
  ...rest
}) {
  const q = React.useMemo(() => CiqrPath(payload), [payload]);
  if (attested && !payload) {
    console.warn('[CkCiqr] attested earns the violet frame only when the payload resolves to a proof object.');
  }
  return /*#__PURE__*/React.createElement("figure", _extends({
    className: ('ck-ciqr' + (attested ? ' ck-ciqr--attested' : '') + (className ? ' ' + className : '')).trim()
  }, rest), q ? /*#__PURE__*/React.createElement("svg", {
    className: "ck-ciqr__code",
    style: {
      width: size + 'px',
      height: size + 'px'
    },
    viewBox: '0 0 ' + q.modules + ' ' + q.modules,
    role: "img",
    ...
    className: "ck-ciqr__code ck-ciqr__code--overflow",
    style: {
      width: size + 'px',
      height: size + 'px'
    }
  }, "\u2298"), /*#__PURE__*/React.createElement("figcaption", {
    className: "ck-ciqr__caption"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-ciqr__mark"
  }, attested ? '◆ ' : '', label), /*#__PURE__*/React.createElement("span", {
    className: "ck-ciqr__note"
  }, q ? caption : 'payload exceeds v5 · EC-L')));
}
Object.assign(__ds_scope, { CiqrPath, CkCiqr });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/CkCiqr.jsx", error: String((e && e.message) || e) }); }

// components/CkIcon.jsx
try { (() => {
/* CKODEX-DS-3 · CkIcon — the drafting icon family.
 *
 * Drawn icons for the product's NOUNS (kernel, gate, margin, proof,
 * receipt, digest, policy, chain, export, replay, audit, gauge,
 * matrix, trend, disclosure, quarantine) and the REGISTRY nouns
 * (system, agent, skill, model, aipack, guardrail). Claim STATES
 * stay glyphs (StateChip / the CNDL safe-set) — an icon is a thing,
 * a glyph is a judgement.
 *
 * Construction law (so the family stays coherent):
 *   · 24×24 engineering grid, content inset to 2–22.
 *   · Hairline strokes, currentColor — an icon inherits ink; the
 *     budget colors it only by context (proof→violet, EP→red), never
 *     by baking hue into the path.
 *   · Square caps, miter joins. Quiet is square: NO rounded corners.
 *   · The chamfer means sealed — only `proof` carries the cut/tick.
 *   · No fills except deliberate nuclei (the dot that means "sealed
 *     core" / "isolated unit").
 *
 * Requires styles.css for the .ck-icon rule. Color via CSS `color`.
 */
const CK_ICON_PATHS = {
  /* ---- structure / kernels ---- */
  kernel: '<path d="M8.5 3 H15.5 L21 8.5 V15.5 L15.5 21 H8.5 L3 15.5 V8.5 Z"/>' + '<circle cx="12" cy="12" r="2" fill="currentColor" stroke="none"/>',
  ...
  chain: '<path d="M6 8.5 L9.5 12 L6 15.5 L2.5 12 Z"/>' + '<path d="M12 8.5 L15.5 12 L12 15.5 L8.5 12 Z"/>' + '<path d="M18 8.5 L21.5 12 L18 15.5 L14.5 12 Z"/>',
  digest: '<path d="M4 5 H20 V19 H4 Z"/><path d="M8 9.5 H16"/><path d="M8 12 H16"/><path d="M8 14.5 H16"/>',
  /* ---- governance documents ---- */
  policy: '<path d="M5.5 3.5 H18.5 V20.5 H5.5 Z"/><path d="M8 8 H16"/><path d="M8 12 H15"/>' + '<path d="M8 15.5 H13"/><circle cx="15.8" cy="17.4" r="1.2" fill="currentColor" stroke="none"/>',
  ...
  quarantine: '<path d="M4 8 V4 H8"/><path d="M16 4 H20 V8"/><path d="M20 16 V20 H16"/><path d="M8 20 H4 V16"/>' + '<circle cx="12" cy="12" r="2" fill="currentColor" stroke="none"/>',
  /* ---- measurement / audit ---- */
  audit: '<path d="M6 4 V20"/>' + '<circle cx="6" cy="8" r="1.5" fill="currentColor" stroke="none"/>' + '<circle cx="6" cy="13" r="1.5" fill="currentColor" stroke="none"/>' + '<circle cx="6" cy="18" r="1.5" fill="currentColor" stroke="none"/>' + '<path d="M9.5 8 H18"/><path d="M9.5 13 H16"/><path d="M9.5 18 H14"/>',
  gauge: '<path d="M4 16 A8 8 0 0 1 20 16"/><path d="M12 16 L16.5 9.5"/>' + '<circle cx="12" cy="16" r="1.5" fill="currentColor" stroke="none"/>',
  matrix: '<path d="M4 4 H20 V20 H4 Z"/><path d="M4 9.33 H20"/><path d="M4 14.66 H20"/>' + '<path d="M9.33 4 V20"/><path d="M14.66 4 V20"/>' + '<rect x="14.66" y="4" width="5.34" height="5.33" fill="currentColor" stroke="none"/>',
  trend: '<path d="M4 19 H20"/><path d="M4 16 L8 11 L12 13 L16 6 L20 9"/>' + '<circle cx="16" cy="6" r="1.4" fill="currentColor" stroke="none"/>',
  /* ---- registry nouns — the governed supply chain ----
     (mirrored in EntityCard.jsx — keep the two tables in sync) */
  system: '<path d="M3.5 3.5 H20.5 V20.5 H3.5 Z"/><path d="M8.5 8.5 H15.5 V15.5 H8.5 Z"/>' + '<path d="M12 3.5 V8.5"/><path d="M12 15.5 V20.5"/><path d="M3.5 12 H8.5"/><path d="M15.5 12 H20.5"/>',
...
const CK_ICON_NAMES = Object.keys(CK_ICON_PATHS);
function CkIcon({
  name,
  size = 20,
  strokeWidth = 1.5,
...
Object.assign(__ds_scope, { CkIcon, CK_ICON_NAMES });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/CkIcon.jsx", error: String((e && e.message) || e) }); }

// components/ComplianceMatrix.jsx
try { (() => {
/* CKODEX-DS-3 · ComplianceMatrix — policies × controls.
 * A grid where each cell is a claim state (the closed set of six,
 * glyphs from the CNDL safe-set). Color obeys the budget, not a
 * health rainbow: only `attested` cells are violet (a proof object),
 * only `quarantined` cells are red (an active EP); observed is ink,
 * inferred/claimed are tone. Requires styles.css. */
const MATRIX_GLYPHS = {
  observed: '⊢',
  inferred: '⇝',
  claimed: '○',
...
function ComplianceMatrix({
  controls = [],
  policies = [],
  corner = 'policy / control',
  className = '',
  ...rest
}) {
  const h = React.createElement;
  const cols = 'minmax(132px, 1.4fr) repeat(' + controls.length + ', minmax(0, 1fr))';
  const cells = [];
  cells.push(h('div', {
    className: 'ck-matrix__cell ck-matrix__rowhead',
    key: 'corner'
  }, corner));
  controls.forEach((c, i) => cells.push(h('div', {
    className: 'ck-matrix__cell ck-matrix__colhead',
    key: 'c' + i
  }, c)));
  policies.forEach((p, ri) => {
    cells.push(h('div', {
      className: 'ck-matrix__cell ck-matrix__rowhead',
      key: 'r' + ri
    }, p.label));
    (p.cells || []).forEach((st, ci) => {
      const s = st || 'na';
      cells.push(h('div', {
        className: 'ck-matrix__cell ck-matrix__state ck-matrix__state--' + s,
        key: 'r' + ri + 'c' + ci,
        title: s
      }, h('span', {
        'aria-hidden': 'true'
  ...
  return h('div', {
    className: ('ck-matrix ' + className).trim(),
    style: {
...
Object.assign(__ds_scope, { ComplianceMatrix, MATRIX_GLYPHS });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/ComplianceMatrix.jsx", error: String((e && e.message) || e) }); }

// components/DisclosureRecord.jsx
try { (() => {
/* CKODEX-DS-3 · DisclosureRecord — one published transparency record.
 * A disclosure is a ledger entry made open: a title, the period and
 * authority, a status, an optional body (which may carry redaction
 * bars), and a verifiable evidence anchor. Transparency is bound to
 * the budget — `disclosed / partial / withheld` carry NO hue; they
 * distinguish by ink weight and inversion. The evidence anchor earns
 * violet only when it is a proof object (`attested`). Requires
 * styles.css. */

/* openness diamond — continuous with the authority handling glyphs */
const DISCLOSURE_GLYPH = {
  disclosed: '○',
  partial: '◇',
  withheld: '◆'
};

/** Redaction bar — withheld text shown as presence without content.
 *  `width` sizes the bar (CSS length); `reason` is the citation. */
function Redaction({
  width = '6ch',
  reason,
  ...rest
...
function DisclosureRecord({
  ...
  const h = React.createElement;
  const metaBits = [period, authority].filter(Boolean).join('  ·  ');
  return h('div', {
    className: ('ck-disclosure ' + className).trim(),
    ...rest
  }, h('div', {
    className: 'ck-disclosure__head'
  }, h('div', {
    className: 'ck-disclosure__headtext'
  }, h('div', {
    className: 'ck-disclosure__title'
  }, h('span', {
    className: 'ck-disclosure__glyph',
    'aria-hidden': 'true',
    style: {
      color: 'var(--ck-fg-3)'
    }
  }, DISCLOSURE_GLYPH[status] || '○'), h('span', null, title)), metaBits ? h('div', {
    className: 'ck-disclosure__meta'
  }, metaBits) : null), h('span', {
    className: 'ck-disclosure__status ck-disclosure__status--' + status
  }, status)), children ? h('div', {
    className: 'ck-disclosure__body'
  }, children) : null, evidence || basis ? h('div', {
    className: 'ck-disclosure__foot'
  }, evidence ? h('span', {
    className: 'ck-hash',
    title: evidence,
    style: attested ? {
      color: 'var(--ck-proof)',
      borderColor: 'color-mix(in oklab, var(--ck-proof) 40%, var(--ck-hairline))'
    } : null
  }, h('span', {
    'aria-hidden': 'true'
  }, attested ? '◆' : '≡'), evidence) : null, basis ? h('span', {
    className: 'ck-disclosure__basis'
  }, basis) : null) : null);
}
Object.assign(__ds_scope, { Redaction, DisclosureRecord, DISCLOSURE_GLYPH });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/DisclosureRecord.jsx", error: String((e && e.message) || e) }); }

// components/EntityCard.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/* CKODEX-DS-3 · EntityCard — the registry identity card.
 *
 * One card per governed thing in the supply chain. The kind is a
 * closed set of six: system · agent · skill · model · aipack ·
 * guardrail — each with its drawn mark from the drafting family
 * (paths mirrored from CkIcon.jsx — keep the two tables in sync).
 *
 * The card carries identity, not marketing: kind + mark, name,
 * URN (operable — copy), facts (owner · version · sealed), and a
 * foot that tells the truth about attestation: a digest earns the
 * violet ◆ stamp and the sealed chamfer (`.ck-sealed`); without one
 * the card says `○ unattested` — presence of absence, never a fake
 * seal. Optional `ciqr` ({path, modules} — from CiqrPath) renders
 * the identity code in the foot. Requires styles.css. */

const ENTITY_KINDS = {
  system: {
    label: 'System',
    mark: '<path d="M3.5 3.5 H20.5 V20.5 H3.5 Z"/><path d="M8.5 8.5 H15.5 V15.5 H8.5 Z"/>' + '<path d="M12 3.5 V8.5"/><path d="M12 15.5 V20.5"/><path d="M3.5 12 H8.5"/><path d="M15.5 12 H20.5"/>'
  },
  agent: {
    label: 'Agent',
    mark: '<circle cx="12" cy="12" r="8.5"/><path d="M12 12 L17.3 6.7"/>' + '<circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/>'
  },
  skill: {
    label: 'Skill',
    mark: '<path d="M5 8.5 L12 4.5 L19 8.5"/><path d="M5 13.25 L12 9.25 L19 13.25"/><path d="M5 18 L12 14 L19 18"/>'
  },
  model: {
    label: 'Model',
    mark: '<path d="M4 4 H20 V20 H4 Z"/><path d="M4 4 L20 20"/><path d="M12 4 L20 12"/><path d="M4 12 L12 20"/>'
  },
  aipack: {
    label: 'AIPack',
    mark: '<path d="M4 6.5 H20 V20 H4 Z"/><path d="M4 10.5 H20"/><path d="M12 10.5 V20"/>' + '<circle cx="12" cy="8.5" r="1.2" fill="currentColor" stroke="none"/>'
  },
  guardrail: {
    label: 'Guardrail',
    mark: '<path d="M3.5 8.5 H20.5"/><path d="M3.5 13 H20.5"/><path d="M6.5 8.5 V20"/><path d="M12 8.5 V20"/><path d="M17.5 8.5 V20"/>'
  }
};
const ENTITY_TIERS = {
  E0: {
...
function EntityCard({
  ...
  const t = tier ? ENTITY_TIERS[tier] : null;
  const attested = !!digest;
  if (!k) {
    console.warn('[EntityCard] kind is a closed set: system · agent · skill · model · aipack · guardrail.');
  }
  if (tier === 'E5' && !attested) {
    console.warn('[EntityCard] tier="E5" is violet only with a discharging proof object — pass `digest`.');
  }
  return /*#__PURE__*/React.createElement("article", _extends({
    className: ('ck-entity' + (attested ? ' ck-sealed' : '') + (className ? ' ' + className : '')).trim(),
    "data-kind": kind
  }, rest), /*#__PURE__*/React.createElement("header", {
    className: "ck-entity__head"
  }, /*#__PURE__*/React.createElement("svg", {
    className: "ck-entity__mark",
    width: 20,
    height: 20,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    className: "ck-entity__kind"
  }, k ? k.label : String(kind)), t ? /*#__PURE__*/React.createElement("span", {
    className: "ck-entity__tier",
    "data-tier": t.k
  }, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true"
  }, t.glyph), " ", tier, " \xB7 ", t.word) : null), /*#__PURE__*/React.createElement("h3", {
    className: "ck-entity__name"
  }, name), urn ? /*#__PURE__*/React.createElement("div", {
    className: "ck-entity__urn"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck-entity__urnval"
  }, urn), /*#__PURE__*/React.createElement(EntityCopyBtn, {
    value: urn
  })) : null, owner || version || sealedAt ? /*#__PURE__*/React.createElement("dl", {
    className: "ck-entity__facts"
  }, owner ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("dt", null, "owner"), /*#__PURE__*/React.createElement("dd", null, owner)) : null, version ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("dt", null, "version"), /*#__PURE__*/React.createElement("dd", null, version)) : null, sealedAt ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("dt", null, "sealed"), /*#__PURE__*/React.createElement("dd", null, sealedAt)) : null) : null, children, /*#__PURE__*/React.createElement("footer", {
    className: "ck-entity__foot"
  }, attested ? /*#__PURE__*/React.createElement("span", {
    className: "ck-stamp",
    title: digest
  }, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true"
  }, "\u25C6"), "sealed \xB7 ", fmtEntityDigest(digest)) : /*#__PURE__*/React.createElement("span", {
    className: "ck-entity__unattested"
  }, "\u25CB unattested"), ciqr ? /*#__PURE__*/React.createElement("svg", {
    className: "ck-entity__ciqr",
    viewBox: '0 0 ' + ciqr.modules + ' ' + ciqr.modules,
    role: "img",
    "aria-label": "CIQR \u2014 scan to resolve canonical evidence",
    shapeRendering: "crispEdges",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/React.createElement("path", {
    d: ciqr.path,
...
Object.assign(__ds_scope, { EntityCard, ENTITY_KINDS });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/EntityCard.jsx", error: String((e && e.message) || e) }); }
...
/* CKODEX-DS-3 · EvidenceMargin — the signature primitive. Evidence is
   ...
   May collapse — but only to a 48px rail, never into a tab. Collapsed,
   the header icon becomes an expand button and the title runs vertically
   down the rail, so the evidence stays a persistent, visible <aside>.
   On a PageShell the grid reflows via :has() so <main> reclaims the
   freed width. Requires styles.css. */

/* The `margin` drafting glyph — doubles as collapse/expand affordance. */
function MarginGlyph() {
  return /*#__PURE__*/React.createElement("svg", {
    className: "ck-icon ck-icon--margin",
    width: 20,
    height: 20,
    viewBox: "0 0 24 24",
    fill: "none",
...
function EvidenceMargin({
  ...
  const isCollapsed = collapsible && (controlled ? collapsed : internalCollapsed);
  const toggle = () => {
  ...
  const toggleBtn = collapsible ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ck-margin__toggle",
    "aria-expanded": !isCollapsed,
    "aria-label": isCollapsed ? 'Expand evidence margin' : 'Collapse evidence margin',
    onClick: toggle
  }, /*#__PURE__*/React.createElement(MarginGlyph, null)) : null;
  if (isCollapsed) {
    return /*#__PURE__*/React.createElement("div", _extends({
      className: ('ck-stack-3 ck-margin ck-margin--collapsed ' + className).trim(),
      "data-ck-margin-collapsed": "true"
    }, rest), toggleBtn, /*#__PURE__*/React.createElement("div", {
      className: "ck-margin__railLabel"
    }, title));
  }
  return /*#__PURE__*/React.createElement("div", _extends({
    className: ('ck-stack-3 ck-margin ' + className).trim(),
    "data-ck-margin-collapsed": collapsible ? 'false' : undefined
  }, rest), collapsible ? /*#__PURE__*/React.createElement("div", {
    className: "ck-margin__head"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ck-label"
  }, title), toggleBtn) : /*#__PURE__*/React.createElement("div", {
    className: "ck-label"
...
try { (() => {
/* CKODEX-DS-3 · Sparkline — a trend over time.
 * Ink line on the engineering grid; optional tone area fill. The
 * area uses a solid ground step (bg-2), never opacity, so it holds
 * under HC's no-semi-transparency floor. Measurement is ink + tone:
 * a sparkline never carries budget hue (a trend is not an assertion).
 * Requires styles.css. */
function Sparkline({
  data = [],
  width = 120,
  ...
  const x = i => pad + (n > 1 ? i * innerW / (n - 1) : innerW / 2);
  const y = v => height - pad - (v - min) / span * innerH;
  const pts = data.map((v, i) => x(i).toFixed(2) + ',' + y(v).toFixed(2));
  const line = 'M ' + pts.join(' L ');
  const areaPath = area ? 'M ' + x(0).toFixed(2) + ',' + (height - pad) + ' L ' + pts.join(' L ') + ' L ' + x(n - 1).toFixed(2) + ',' + (height - pad) + ' Z' : null;
  const baseY = baseline !== undefined && baseline !== null ? y(baseline) : null;
  const h = React.createElement;
  const a11y = label ? {
    role: 'img',
    'aria-label': label
  ...
  return h('svg', {
    className: ('ck-spark ' + className).trim(),
    width,
    height,
    ...
    d: areaPath,
    key: 'a'
  }) : null, baseY !== null ? h('line', {
    className: 'ck-spark__base',
    x1: pad,
    y1: baseY,
    x2: width - pad,
    y2: baseY,
    ...
    strokeWidth,
    key: 'l'
  }), marker === 'last' ? h('circle', {
    className: 'ck-spark__node',
    cx: x(n - 1),
    cy: y(data[n - 1]),
    r: 1.8,
    key: 'm'
...
(function (root) {
  ...
  function CkDotBg(opts) {
    ...
    const cc = MAJ / 2;
    const crosshair = `<path d="M ${cc - ca} ${cc} H ${cc + ca} M ${cc} ${cc - ca} V ${cc + ca}" ` + `stroke="${t.cross}" stroke-width="${cw}" opacity="${t.crossOp}" ` + `stroke-linecap="square" fill="none"/>`;
    ...
    const ins = 14,
      arm = 8,
      bw = isHc ? 1.5 : 1.1;
    const brk = (x, y, sx, sy) => `<path d="M ${x} ${y + sy * arm} V ${y} H ${x + sx * arm}" fill="none" stroke="${fur}" stroke-width="${bw}" opacity="${t.brkOp}" stroke-linecap="square"/>`;
    ...
    const lift = t.liftOp > 0 ? `<linearGradient id="${uid}-lift" x1="0" y1="0" x2="0" y2="1">
    ...
    const vig = t.vig ? `<radialGradient id="${uid}-vig" cx="50%" cy="46%" r="74%">
...
__ds_ns.AuthorityFooter = __ds_scope.AuthorityFooter;

__ds_ns.Button = __ds_scope.Button;

__ds_ns.CiqrPath = __ds_scope.CiqrPath;

__ds_ns.CkCiqr = __ds_scope.CkCiqr;

__ds_ns.CkIcon = __ds_scope.CkIcon;

__ds_ns.CK_ICON_NAMES = __ds_scope.CK_ICON_NAMES;

__ds_ns.ComplianceMatrix = __ds_scope.ComplianceMatrix;

__ds_ns.MATRIX_GLYPHS = __ds_scope.MATRIX_GLYPHS;

__ds_ns.Redaction = __ds_scope.Redaction;

__ds_ns.DisclosureRecord = __ds_scope.DisclosureRecord;

__ds_ns.DISCLOSURE_GLYPH = __ds_scope.DISCLOSURE_GLYPH;

__ds_ns.EntityCard = __ds_scope.EntityCard;

__ds_ns.ENTITY_KINDS = __ds_scope.ENTITY_KINDS;
